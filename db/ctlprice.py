...
class Handler(QtWidgets.QWidget,usercontrol):
	...
	def GTKForms(self):
		...
		self.createwidget("{'Var': '', 'Help': '', 'Height': '20', 'Events': '[clicked]', 'Name': 'btnok_price', 'Visible': 'True', 'Tag': '', 'ForeColor': '(0,0,0,1)', 'Top': '30', 'Enable': 'True', 'Picture': '', 'Text': 'ok', 'Left': '0', 'Width': '170', 'Font': '', 'ParentsType': '', 'BackColor': '(1,1,1,1)'}",'QPushButton','usercontrol',"[['clicked', 'self,e']]")
		self.createwidget("{'Var': '', 'Help': '', 'Height': '20', 'Events': '[clicked]', 'Name': 'btncancel_price', 'Visible': 'True', 'Tag': '', 'ForeColor': '(0,0,0,1)', 'Top': '30', 'Enable': 'True', 'Picture': '', 'Text': 'cancel', 'Left': '170', 'Width': '170', 'Font': '', 'ParentsType': '', 'BackColor': '(1,1,1,1)'}",'QPushButton','usercontrol',"[['clicked', 'self,e']]")
		self.createwidget("{'Var': '', 'Help': '', 'Height': '20', 'Events': '[clicked]', 'Name': 'btninsert_price', 'Visible': 'True', 'Tag': '', 'ForeColor': '(0,0,0,1)', 'Top': '30', 'Enable': 'True', 'Picture': '', 'Text': 'insert', 'Left': '340', 'Width': '170', 'Font': '', 'ParentsType': '', 'BackColor': '(1,1,1,1)'}",'QPushButton','usercontrol',"[['clicked', 'self,e']]")
		self.createwidget("{'Var': '', 'Help': '', 'Height': '20', 'Events': '[clicked]', 'Name': 'btndelete_price', 'Visible': 'True', 'Tag': '', 'ForeColor': '(0,0,0,1)', 'Top': '30', 'Enable': 'True', 'Picture': '', 'Text': 'delete', 'Left': '510', 'Width': '170', 'Font': '', 'ParentsType': '', 'BackColor': '(1,1,1,1)'}",'QPushButton','usercontrol',"[['clicked', 'self,e']]")
		self.createwidget("{'Var': '', 'Help': '', 'Height': '20', 'Events': '[clicked]', 'Name': 'btnupdate_price', 'Visible': 'True', 'Tag': '', 'ForeColor': '(0,0,0,1)', 'Top': '30', 'Enable': 'True', 'Picture': '', 'Text': 'update', 'Left': '680', 'Width': '170', 'Font': '', 'ParentsType': '', 'BackColor': '(1,1,1,1)'}",'QPushButton','usercontrol',"[['clicked', 'self,e']]")
	def Widget(self):
		return self
