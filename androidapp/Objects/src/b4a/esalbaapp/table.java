...
public class table extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.esalbaapp.table");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.esalbaapp.table.class).invoke(this, new Object[] {null});
        else
...
__c.LogImpl("83538947","Wrong number of values.",0);
...
_rc = (b4a.esalbaapp.table._rowcol)(_l.getTag());
...
_rc = (b4a.esalbaapp.table._rowcol)(_lbls[_i].getTag());
...
__c.LogImpl("83735557","HideRow: (null) "+BA.NumberToString(_row),0);
