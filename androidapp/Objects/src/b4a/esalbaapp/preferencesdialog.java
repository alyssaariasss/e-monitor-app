...
public class preferencesdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.esalbaapp.preferencesdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.esalbaapp.preferencesdialog.class).invoke(this, new Object[] {null});
        else
...
public b4a.esalbaapp.b4xdatetemplate _datetemplate = null;
public b4a.esalbaapp.b4xlongtexttemplate _longtexttemplate = null;
...
public b4a.esalbaapp.b4xsearchtemplate _searchtemplate = null;
public Object _template = null;
public b4a.esalbaapp.b4xcolortemplate _colortemplate = null;
public b4a.esalbaapp.b4xcombobox _b4xcombobox1 = null;
...
b4a.esalbaapp.preferencesdialog._b4xprefitem _pi = null;
...
_datetemplate = new b4a.esalbaapp.b4xdatetemplate();
 //BA.debugLineNum = 13;BA.debugLine="Public LongTextTemplate As B4XLongTextTemplate";
_longtexttemplate = new b4a.esalbaapp.b4xlongtexttemplate();
...
_searchtemplate = new b4a.esalbaapp.b4xsearchtemplate();
...
_colortemplate = new b4a.esalbaapp.b4xcolortemplate();
 //BA.debugLineNum = 21;BA.debugLine="Private B4XComboBox1 As B4XComboBox";
_b4xcombobox1 = new b4a.esalbaapp.b4xcombobox();
...
b4a.esalbaapp.preferencesdialog._b4xprefitem _prefitem = null;
anywheresoftware.b4a.objects.B4XViewWrapper _itempanel = null;
boolean _required = false;
Object _value = null;
b4a.esalbaapp.b4xswitch _switch = null;
b4a.esalbaapp.b4xfloattextfield _ft = null;
double _n = 0;
int _n2 = 0;
b4a.esalbaapp.b4xplusminus _pmhours = null;
b4a.esalbaapp.b4xplusminus _pmminutes = null;
b4a.esalbaapp.b4xplusminus _pmampm = null;
b4a.example.dateutils._period _p = null;
b4a.esalbaapp.b4xplusminus _pm = null;
b4a.esalbaapp.b4xcombobox _cmb = null;
...
if ((_item.Value instanceof b4a.esalbaapp.preferencesdialog._b4xprefitem)==__c.False) { 
if (true) break;};
 //BA.debugLineNum = 697;BA.debugLine="Dim PrefItem As B4XPrefItem = Item.Value";
_prefitem = (b4a.esalbaapp.preferencesdialog._b4xprefitem)(_item.Value);
...
_switch = (b4a.esalbaapp.b4xswitch)(_itempanel.GetView((int) (1)).getTag());
...
_ft = (b4a.esalbaapp.b4xfloattextfield)(_itempanel.GetView((int) (0)).getTag());
...
_pmhours = (b4a.esalbaapp.b4xplusminus)(_itempanel.GetView((int) (0)).getTag());
 //BA.debugLineNum = 732;BA.debugLine="Dim pmMinutes As B4XPlusMinus = ItemPanel.GetV";
_pmminutes = (b4a.esalbaapp.b4xplusminus)(_itempanel.GetView((int) (1)).getTag());
 //BA.debugLineNum = 733;BA.debugLine="Dim pmAMPM As B4XPlusMinus = ItemPanel.GetView";
_pmampm = (b4a.esalbaapp.b4xplusminus)(_itempanel.GetView((int) (2)).getTag());
...
_pm = (b4a.esalbaapp.b4xplusminus)(_itempanel.GetView((int) (0)).getTag());
...
_cmb = (b4a.esalbaapp.b4xcombobox)(_itempanel.GetView((int) (1)).getTag());
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _createlayouts(b4a.esalbaapp.preferencesdialog._b4xprefitem _prefitem) throws Exception{
...
String _opt = "";
b4a.esalbaapp.b4xfloattextfield _tf = null;
...
_ft = (b4a.esalbaapp.b4xfloattextfield)(_p.GetView((int) (0)).getTag());
...
_tf = (b4a.esalbaapp.b4xfloattextfield)(_p.GetView((int) (0)).getTag());
...
if (_p.GetView((int) (0)).getTag() instanceof b4a.esalbaapp.b4xfloattextfield) { 
...
public String  _createnumericrangeitem(b4a.esalbaapp.preferencesdialog._b4xprefitem _prefitem,anywheresoftware.b4a.objects.B4XViewWrapper _p) throws Exception{
b4a.esalbaapp.b4xplusminus _pm = null;
...
_pm = (b4a.esalbaapp.b4xplusminus)(_p.GetView((int) (0)).getTag());
...
_pm._formatter /*b4a.esalbaapp.b4xformatter*/ ._getdefaultformat /*b4a.esalbaapp.b4xformatter._b4xformatdata*/ ().MaximumFractions /*int*/  = (int) (2);
...
public b4a.esalbaapp.preferencesdialog._b4xprefitem  _createprefitem(Object _title,int _itemtype,String _key) throws Exception{
b4a.esalbaapp.preferencesdialog._b4xprefitem _pi = null;
...
_pi = new b4a.esalbaapp.preferencesdialog._b4xprefitem();
...
public String  _createtimeitem(b4a.esalbaapp.preferencesdialog._b4xprefitem _prefitem,anywheresoftware.b4a.objects.B4XViewWrapper _p) throws Exception{
boolean _is24 = false;
b4a.esalbaapp.b4xplusminus _pmhours = null;
b4a.esalbaapp.b4xplusminus _pmminutes = null;
b4a.esalbaapp.b4xplusminus _pmampm = null;
...
_pmhours = (b4a.esalbaapp.b4xplusminus)(_p.GetView((int) (0)).getTag());
...
_pmminutes = (b4a.esalbaapp.b4xplusminus)(_p.GetView((int) (1)).getTag());
 //BA.debugLineNum = 667;BA.debugLine="Dim pmAMPM As B4XPlusMinus = p.GetView(2).Tag";
_pmampm = (b4a.esalbaapp.b4xplusminus)(_p.GetView((int) (2)).getTag());
...
_pmminutes._formatter /*b4a.esalbaapp.b4xformatter*/ ._getdefaultformat /*b4a.esalbaapp.b4xformatter._b4xformatdata*/ ().MinimumIntegers /*int*/  = (int) (2);
...
__c.LogImpl("920447281","Unknown type: "+BA.NumberToString(_prefitem.ItemType /*int*/ ),0);
 break; }
}
;
 }
...
public anywheresoftware.b4a.objects.B4XViewWrapper  _getpanel(b4a.esalbaapp.b4xdialog _dialog1) throws Exception{
...
public b4a.esalbaapp.preferencesdialog._b4xprefitem  _getprefitem(String _key) throws Exception{
b4a.esalbaapp.preferencesdialog._b4xprefitem _pi = null;
...
_pi = (b4a.esalbaapp.preferencesdialog._b4xprefitem)(group1.Get(index1));
...
if (true) return (b4a.esalbaapp.preferencesdialog._b4xprefitem)(__c.Null);
 //BA.debugLineNum = 902;BA.debugLine="End Sub";
return null;
}
public Object  _getprefitemvalue(b4a.esalbaapp.preferencesdialog._b4xprefitem _prefitem,Object _defaultvalue,anywheresoftware.b4a.objects.collections.Map _data) throws Exception{
...
public ResumableSub_GoToItem(b4a.esalbaapp.preferencesdialog parent,int _i) {
this.parent = parent;
this._i = _i;
}
b4a.esalbaapp.preferencesdialog parent;
int _i;
anywheresoftware.b4a.objects.B4XViewWrapper _p = null;
int _duration = 0;
int step3;
...
anywheresoftware.b4a.objects.B4XViewWrapper _v = null;
b4a.esalbaapp.b4xfloattextfield _f = null;
int _index = 0;
...
if (_v.getTag() instanceof b4a.esalbaapp.b4xfloattextfield) { 
 //BA.debugLineNum = 91;BA.debugLine="Dim f As B4XFloatTextField = v.Tag";
_f = (b4a.esalbaapp.b4xfloattextfield)(_v.getTag());
...
b4a.esalbaapp.preferencesdialog._b4xprefitem _pref = null;
...
_pref = (b4a.esalbaapp.preferencesdialog._b4xprefitem)(_customlistview1._getvalue(_nesteddialogitemindex));
...
_pi = (b4a.esalbaapp.preferencesdialog._b4xprefitem)(_prefitems.Get((int) (_prefitems.getSize()-1)));
...
_ft = (b4a.esalbaapp.b4xfloattextfield)(_lbl.getParent().GetView((int) (0)).getTag());
...
_searchtemplate._searchfield /*b4a.esalbaapp.b4xfloattextfield*/ ._gettextfield /*anywheresoftware.b4a.objects.B4XViewWrapper*/ ().setTextColor(_textcolor);
 //BA.debugLineNum = 482;BA.debugLine="SearchTemplate.SearchField.NonFocusedHintColor =";
_searchtemplate._searchfield /*b4a.esalbaapp.b4xfloattextfield*/ ._nonfocusedhintcolor /*int*/  = _textcolor;
...
public String  _show(b4a.esalbaapp.b4xdialog _dialog1) throws Exception{
...
public ResumableSub_ShowDialog(b4a.esalbaapp.preferencesdialog parent,anywheresoftware.b4a.objects.collections.Map _data,Object _yes,Object _cancel) {
this.parent = parent;
this._data = _data;
this._yes = _yes;
...
Object _yes;
Object _cancel;
b4a.esalbaapp.b4xfloattextfield _lasttextfield = null;
b4a.esalbaapp.preferencesdialog._b4xprefitem _pi = null;
...
_lasttextfield = new b4a.esalbaapp.b4xfloattextfield();
...
if (index3 < groupLen3) {
this.state = 6;
_pi = (b4a.esalbaapp.preferencesdialog._b4xprefitem)(group3.Get(index3));}
if (true) break;
...
//if
this.state = 14;
if (_pnl.GetView((int) (0)).getTag() instanceof b4a.esalbaapp.b4xfloattextfield) { 
this.state = 9;
}if (true) break;
...
_tf = (b4a.esalbaapp.b4xfloattextfield)(_pnl.GetView((int) (0)).getTag());
...
_lasttextfield._setnextfield /*b4a.esalbaapp.b4xfloattextfield*/ (_tf);
 if (true) break;
...
//C
this.state = 20;
_lasttextfield._setnextfield /*b4a.esalbaapp.b4xfloattextfield*/ (_lasttextfield);
if (true) break;
...
_ft = (b4a.esalbaapp.b4xfloattextfield)(__c.Sender(ba));
...
public String  _twolabelslayout(String _eventname,anywheresoftware.b4a.objects.B4XViewWrapper _p,b4a.esalbaapp.preferencesdialog._b4xprefitem _prefitem) throws Exception{
...
if (BA.fastSubCompare(sub, "GETPANEL"))
	return _getpanel((b4a.esalbaapp.b4xdialog) args[0]);
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((b4a.esalbaapp.b4xdialog) args[0]);
