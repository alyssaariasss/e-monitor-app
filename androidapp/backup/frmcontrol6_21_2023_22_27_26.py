...
class Handler(QtWidgets.QWidget,usercontrol):
	...
	def GTKForms(self):
		self.createwidget("{'Name': 'mBase', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '-40', 'Width': '400', 'ParentsType': '', 'Picture': 'cat.png', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '600', 'Left': '0', 'Tag': '', 'Text': '', 'Help': ''}",'QLabel','usercontrol',"[]")
		...
		self.createwidget("{'Name': 'btnback', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '10', 'Width': '70', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '40', 'Left': '10', 'Tag': '', 'Text': '<<', 'Help': ''}",'QPushButton','usercontrol',"[]")
		...
		self.createwidget("{'Name': 'line1', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '80', 'Width': '345', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '35', 'Left': '30', 'Tag': '', 'Text': 'QLabel9', 'Help': ''}",'QLabel','usercontrol',"[]")
		self.createwidget("{'Name': 'line2', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '140', 'Width': '345', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '35', 'Left': '30', 'Tag': '', 'Text': 'QLabel9', 'Help': ''}",'QLabel','usercontrol',"[]")
		self.createwidget("{'Name': 'line3', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '205', 'Width': '345', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '35', 'Left': '30', 'Tag': '', 'Text': 'QLabel9', 'Help': ''}",'QLabel','usercontrol',"[]")
	def Widget(self):
		return self    
	def loop(self):
