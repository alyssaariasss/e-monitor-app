...
class Handler(QtWidgets.QWidget,usercontrol):
	...
	def GTKForms(self):
		...
		self.createwidget("{'Name': 'on1', 'Var': '', 'Font': 'Arial Rounded MT Bold 9', 'Enable': 'True', 'Top': '100', 'Width': '80', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '40', 'Left': '100', 'Tag': '', 'Text': 'O N', 'Help': ''}",'QPushButton','usercontrol',"[]")
		self.createwidget("{'Name': 'on3', 'Var': '', 'Font': 'Arial Rounded MT Bold 9', 'Enable': 'True', 'Top': '440', 'Width': '80', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '40', 'Left': '100', 'Tag': '', 'Text': 'O N', 'Help': ''}",'QPushButton','usercontrol',"[]")
		self.createwidget("{'Name': 'on2', 'Var': '', 'Font': 'Arial Rounded MT Bold 9', 'Enable': 'True', 'Top': '270', 'Width': '80', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '40', 'Left': '100', 'Tag': '', 'Text': 'O N', 'Help': ''}",'QPushButton','usercontrol',"[]")
		self.createwidget("{'Name': 'off1', 'Var': '', 'Font': 'Arial Rounded MT Bold 9', 'Enable': 'True', 'Top': '100', 'Width': '80', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '40', 'Left': '215', 'Tag': '', 'Text': 'O F F', 'Help': ''}",'QPushButton','usercontrol',"[]")
		self.createwidget("{'Name': 'off2', 'Var': '', 'Font': 'Arial Rounded MT Bold 9', 'Enable': 'True', 'Top': '270', 'Width': '80', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '40', 'Left': '215', 'Tag': '', 'Text': 'O F F', 'Help': ''}",'QPushButton','usercontrol',"[]")
		self.createwidget("{'Name': 'off3', 'Var': '', 'Font': 'Arial Rounded MT Bold 9', 'Enable': 'True', 'Top': '440', 'Width': '80', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '40', 'Left': '215', 'Tag': '', 'Text': 'O F F', 'Help': ''}",'QPushButton','usercontrol',"[]")
