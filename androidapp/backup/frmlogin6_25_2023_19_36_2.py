...
class Handler(QtWidgets.QWidget,usercontrol):
	...
	def GTKForms(self):
		self.createwidget("{'Name': 'mBase', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '-10', 'Width': '400', 'ParentsType': '', 'Picture': 'Files/cat.png', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '600', 'Left': '5', 'Tag': '', 'Text': '', 'Help': ''}",'QLabel','usercontrol',"[]")
		...
		self.createwidget("{'Name': 'txtEmail', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '260', 'Width': '230', 'ParentsType': '', 'Picture': '', 'ForeColor': '[0.9647058823529412, 0.9686274509803922, 0.9686274509803922, 1.0]', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '35', 'Left': '125', 'Tag': '', 'Text': 'shaideudor.smd', 'Help': ''}",'QLineEdit','usercontrol',"[]")
		...
		self.createwidget("{'Name': 'QLabel5', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '130', 'Width': '250', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '30', 'Left': '75', 'Tag': '', 'Text': "Login to view your household's", 'Help': ''}",'QLabel','usercontrol',"[]")
		...
		self.createwidget("{'Name': 'txtPassword', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '310', 'Width': '230', 'ParentsType': '', 'Picture': '', 'ForeColor': '[0.9647058823529412, 0.9686274509803922, 0.9686274509803922, 1.0]', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '35', 'Left': '125', 'Tag': '', 'Text': '123456789', 'Help': ''}",'QLabel','usercontrol',"[]")
	def Widget(self):
		return self    
	def loop(self):
