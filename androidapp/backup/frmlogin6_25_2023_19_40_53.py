...
class Handler(QtWidgets.QWidget,usercontrol):
	...
	def GTKForms(self):
		...
		self.createwidget("{'Name': 'QLabel8', 'Var': '', 'Font': '', 'Enable': 'True', 'Top': '140', 'Width': '220', 'ParentsType': '', 'Picture': '', 'ForeColor': '(0,0,0,1)', 'Visible': 'True', 'BackColor': '(1,1,1,0.25)', 'Events': [], 'Height': '25', 'Left': '90', 'Tag': '', 'Text': "Login to view your household's", 'Help': ''}",'QLabel','usercontrol',"[]")
	def Widget(self):
		return self    
	def loop(self):
