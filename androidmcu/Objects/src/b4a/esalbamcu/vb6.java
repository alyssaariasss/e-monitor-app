...
anywheresoftware.b4a.keywords.Common.LogImpl("42818061",BA.ObjectToString((anywheresoftware.b4a.keywords.Common.GetType((Object)(""))).equals("java.lang.Integer")),0);
 //BA.debugLineNum = 128;BA.debugLine="Log(\"Key: \" & am.GetKeyAt(i))";
anywheresoftware.b4a.keywords.Common.LogImpl("42818062","Key: "+BA.ObjectToString(_am.GetKeyAt(_i)),0);
 //BA.debugLineNum = 129;BA.debugLine="Log(\"Value: \" & am.GetValueAt(i))";
anywheresoftware.b4a.keywords.Common.LogImpl("42818063","Value: "+BA.ObjectToString(_am.GetValueAt(_i)),0);
 }
};
