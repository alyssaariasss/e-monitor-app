...
public class clswidget extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.esalbamcu.clswidget");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.esalbamcu.clswidget.class).invoke(this, new Object[] {null});
        else
...
public b4a.esalbamcu.b4xdatetemplate _date = null;
public b4a.esalbamcu.b4xdialog _dialog = null;
public b4a.esalbamcu.b4xinputtemplate _inputtemplate = null;
...
_date = new b4a.esalbamcu.b4xdatetemplate();
...
_inputtemplate = new b4a.esalbamcu.b4xinputtemplate();
...
public ResumableSub_dashboard(b4a.esalbamcu.clswidget parent,mpandroidchartwrapper.lineChartWrapper _graphx,String _sql,String _code) {
this.parent = parent;
this._graphx = _graphx;
this._sql = _sql;
this._code = _code;
}
b4a.esalbamcu.clswidget parent;
...
_cls = parent._starter._querryserver /*b4a.esalbamcu.clsparser*/ (_code,BA.ObjectToString(parent.__c.Chr((int) (13))),_sql);
...
parent.__c.LogImpl("439583752",_cls._data /*String*/ ,0);
...
_j = parent._starter._wsh /*b4a.esalbamcu.wtaserver*/ ._tolist /*anywheresoftware.b4a.objects.collections.List*/ (_cls._data /*String*/ );
...
public void  _datagrid(b4a.esalbamcu.table _datagrid6,String _sql,String _fields,String _id) throws Exception{
...
public ResumableSub_Datagrid(b4a.esalbamcu.clswidget parent,b4a.esalbamcu.table _datagrid6,String _sql,String _fields,String _id) {
this.parent = parent;
...
b4a.esalbamcu.clswidget parent;
b4a.esalbamcu.table _datagrid6;
String _sql;
String _fields;
String _id;
b4a.esalbamcu.clsparser _cls = null;
...
_cls = parent._starter._querryserver /*b4a.esalbamcu.clsparser*/ (_id,BA.ObjectToString(parent.__c.Chr((int) (13))),_sql);
...
parent.__c.LogImpl("439649287",_cls._data /*String*/ ,0);
...
parent._starter._wsh /*b4a.esalbamcu.wtaserver*/ ._datagrid /*String*/ (_datagrid6,_cls._data /*String*/ ,_fields);
 if (true) break;
...
public ResumableSub_DateDialog(b4a.esalbamcu.clswidget parent,anywheresoftware.b4a.objects.B4XViewWrapper _base) {
this.parent = parent;
this._base = _base;
}
b4a.esalbamcu.clswidget parent;
...
parent.__c.LogImpl("439452676",parent.__c.DateTime.Date(parent._date._getdate /*long*/ ()),0);
 if (true) break;
...
public ResumableSub_FileDialog(b4a.esalbamcu.clswidget parent,anywheresoftware.b4a.objects.B4XViewWrapper _base) {
this.parent = parent;
this._base = _base;
}
b4a.esalbamcu.clswidget parent;
...
parent.__c.LogImpl("439387156","error",0);
 if (true) break;
...
public ResumableSub_Querry(b4a.esalbamcu.clswidget parent,String _sql,String _id) {
this.parent = parent;
this._sql = _sql;
this._id = _id;
}
...
parent.__c.LogImpl("439714825",_cls._data /*String*/ ,0);
...
_ret = parent._starter._wsh /*b4a.esalbamcu.wtaserver*/ ._tolist /*anywheresoftware.b4a.objects.collections.List*/ (_cls._data /*String*/ );
 if (true) break;
...
public ResumableSub_TimeDialog(b4a.esalbamcu.clswidget parent,anywheresoftware.b4a.objects.B4XViewWrapper _base) {
this.parent = parent;
this._base = _base;
}
b4a.esalbamcu.clswidget parent;
...
parent.__c.LogImpl("439518213",parent._inputtemplate._text /*String*/ ,0);
 if (true) break;
