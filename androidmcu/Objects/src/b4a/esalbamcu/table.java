...
public class table extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "b4a.esalbamcu.table");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", b4a.esalbamcu.table.class).invoke(this, new Object[] {null});
        else
...
int _lastrow = 0;
 ...
 //BA.debugLineNum = 148;BA.debugLine="If Values.Length <> NumberOfColumns Then	'If Valu";
if (_values.length!=_numberofcolumns) { 
 //BA.debugLineNum = 149;BA.debugLine="Log(\"Wrong number of values.\")";
__c.LogImpl("44456451","Wrong number of values.",0);
...
_rc = (b4a.esalbamcu.table._rowcol)(_l.getTag());
...
_rc = (b4a.esalbamcu.table._rowcol)(_lbls[_i].getTag());
...
String[] _values = null;
 //BA.debugLineNum = 277;BA.debugLine="Public Sub GetValue(Col As Int, Row As Int)";
...
_values = (String[])(_data.Get(_row));
 //BA.debugLineNum = 280;BA.debugLine="Return values(Col)";
...
__c.LogImpl("44653061","HideRow: (null) "+BA.NumberToString(_row),0);
...
public String  _jumptorow(int _row) throws Exception{
 //BA.debugLineNum = 315;BA.debugLine="Public Sub JumpToRow(Row As Int)";
 //BA.debugLineNum = 316;BA.debugLine="SV.ScrollPosition = Row * RowHeight";
...
String[] _row = null;
 //BA.debugLineNum = 321;BA.debugLine="Public Sub LoadTableFromCSV(Dir As String, Filenam";
 //BA.debugLineNum = 323;BA.debugLine="Dim List1 As List";
_list1 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 324;BA.debugLine="Dim h() As String";
_h = new String[(int) (0)];
java.util.Arrays.fill(_h,"");
 //BA.debugLineNum = 325;BA.debugLine="If HeadersExist Then";
if (_headersexist) { 
 //BA.debugLineNum = 326;BA.debugLine="Dim headers As List";
_headers = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 327;BA.debugLine="List1 = StringUtils1.LoadCSV2(Dir, Filename, \",\"";
_list1 = _stringutils1.LoadCSV2(_dir,_filename,BA.ObjectToChar(","),_headers);
 //BA.debugLineNum = 328;BA.debugLine="Dim h(headers.Size) As String";
_h = new String[_headers.getSize()];
java.util.Arrays.fill(_h,"");
 //BA.debugLineNum = 329;BA.debugLine="For i = 0 To headers.Size - 1";
{
final int step7 = 1;
final int limit7 = (int) (_headers.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit7 ;_i = _i + step7 ) {
 //BA.debugLineNum = 330;BA.debugLine="h(i) = headers.Get(i)";
_h[_i] = BA.ObjectToString(_headers.Get(_i));
 }
};
 }else {
 //BA.debugLineNum = 333;BA.debugLine="List1 = StringUtils1.LoadCSV(Dir, Filename, \",\")";
_list1 = _stringutils1.LoadCSV(_dir,_filename,BA.ObjectToChar(","));
 //BA.debugLineNum = 334;BA.debugLine="Dim firstRow() As String";
_firstrow = new String[(int) (0)];
java.util.Arrays.fill(_firstrow,"");
 //BA.debugLineNum = 335;BA.debugLine="firstRow = List1.Get(0)";
_firstrow = (String[])(_list1.Get((int) (0)));
 //BA.debugLineNum = 336;BA.debugLine="Dim h(firstRow.Length)";
_h = new String[_firstrow.length];
java.util.Arrays.fill(_h,"");
 //BA.debugLineNum = 337;BA.debugLine="For i = 0 To firstRow.Length - 1";
{
final int step15 = 1;
final int limit15 = (int) (_firstrow.length-1);
_i = (int) (0) ;
for (;_i <= limit15 ;_i = _i + step15 ) {
 //BA.debugLineNum = 338;BA.debugLine="h(i) = \"Col\" & (i + 1)";
_h[_i] = "Col"+BA.NumberToString((_i+1));
 }
};
 };
 //BA.debugLineNum = 341;BA.debugLine="innerClearAll(h.Length)";
_innerclearall(_h.length);
 //BA.debugLineNum = 342;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns";
_columnwidth = (int) (_sv.getWidth()/(double)_numberofcolumns);
 //BA.debugLineNum = 343;BA.debugLine="SetHeader(h)";
_setheader(_h);
 //BA.debugLineNum = 344;BA.debugLine="For i = 0 To List1.Size - 1";
{
final int step22 = 1;
final int limit22 = (int) (_list1.getSize()-1);
_i = (int) (0) ;
for (;_i <= limit22 ;_i = _i + step22 ) {
 //BA.debugLineNum = 345;BA.debugLine="Dim row() As String";
_row = new String[(int) (0)];
java.util.Arrays.fill(_row,"");
 //BA.debugLineNum = 346;BA.debugLine="row = List1.Get(i)";
_row = (String[])(_list1.Get(_i));
 //BA.debugLineNum = 347;BA.debugLine="AddRow(row)";
_addrow(_row);
 }
};
...
int _i = 0;
anywheresoftware.b4a.objects.LabelWrapper _l = null;
 //BA.debugLineNum = 360;BA.debugLine="Public Sub SaveTableToCSV(Dir As String, Filename";
 //BA.debugLineNum = 361;BA.debugLine="Dim headers(NumberOfColumns) As String";
_headers = new String[_numberofcolumns];
java.util.Arrays.fill(_headers,"");
 //BA.debugLineNum = 362;BA.debugLine="For i = 0 To headers.Length - 1";
{
final int step2 = 1;
final int limit2 = (int) (_headers.length-1);
_i = (int) (0) ;
for (;_i <= limit2 ;_i = _i + step2 ) {
 //BA.debugLineNum = 363;BA.debugLine="Dim l As Label";
_l = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 364;BA.debugLine="l = Header.GetView(i)";
_l = (anywheresoftware.b4a.objects.LabelWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.LabelWrapper(), (android.widget.TextView)(_header.GetView(_i).getObject()));
 //BA.debugLineNum = 365;BA.debugLine="headers(i) = l.Text";
_headers[_i] = _l.getText();
 }
};
 //BA.debugLineNum = 367;BA.debugLine="StringUtils1.SaveCSV2(Dir, Filename, \",\", Data, h";
...
int _prev = 0;
int _col = 0;
 //BA.debugLineNum = 294;BA.debugLine="Private Sub SelectRow(Row As Int)";
 //BA.debugLineNum = 295;BA.debugLine="Dim prev As Int";
_prev = 0;
 //BA.debugLineNum = 296;BA.debugLine="prev = SelectedRow";
_prev = _selectedrow;
 //BA.debugLineNum = 297;BA.debugLine="SelectedRow = Row";
_selectedrow = _row;
 //BA.debugLineNum = 299;BA.debugLine="If prev > -1 Then";
if (_prev>-1) { 
 //BA.debugLineNum = 300;BA.debugLine="If visibleRows.ContainsKey(prev) Then";
if (_visiblerows.ContainsKey((Object)(_prev))) { 
 //BA.debugLineNum = 301;BA.debugLine="HideRow(prev)";
_hiderow(_prev);
 //BA.debugLineNum = 302;BA.debugLine="ShowRow(prev)";
_showrow(_prev);
 };
 };
 //BA.debugLineNum = 305;BA.debugLine="SelectedRow = Row";
_selectedrow = _row;
 //BA.debugLineNum = 306;BA.debugLine="For col = 0 To NumberOfColumns - 1";
{
final int step11 = 1;
final int limit11 = (int) (_numberofcolumns-1);
_col = (int) (0) ;
for (;_col <= limit11 ;_col = _col + step11 ) {
 //BA.debugLineNum = 307;BA.debugLine="If visibleRows.ContainsKey(SelectedRow) Then";
if (_visiblerows.ContainsKey((Object)(_selectedrow))) { 
 //BA.debugLineNum = 308;BA.debugLine="HideRow(SelectedRow)";
_hiderow(_selectedrow);
 //BA.debugLineNum = 309;BA.debugLine="ShowRow(SelectedRow)";
...
Object _a = null;
 //BA.debugLineNum = 350;BA.debugLine="public Sub SetDatagrid(HeaderX() As String,x As Li";
 //BA.debugLineNum = 352;BA.debugLine="innerClearAll(HeaderX.Length)";
_innerclearall(_headerx.length);
 //BA.debugLineNum = 353;BA.debugLine="ColumnWidth = SV.Width / NumberOfColumns";
_columnwidth = (int) (_sv.getWidth()/(double)_numberofcolumns);
 //BA.debugLineNum = 354;BA.debugLine="SetHeader(HeaderX)";
_setheader(_headerx);
 //BA.debugLineNum = 355;BA.debugLine="For Each a In x";
{
...
_a = group4.Get(index4);
 //BA.debugLineNum = 356;BA.debugLine="AddRow(a)";
_addrow((String[])(_a));
 }
};
...
String[] _values = null;
anywheresoftware.b4a.objects.LabelWrapper[] _lbls = null;
 //BA.debugLineNum = 283;BA.debugLine="Public Sub SetValue(Col As Int, Row As Int, Value";
 //BA.debugLineNum = 284;BA.debugLine="Dim values() As String";
_values = new String[(int) (0)];
java.util.Arrays.fill(_values,"");
 //BA.debugLineNum = 285;BA.debugLine="values = Data.Get(Row)";
_values = (String[])(_data.Get(_row));
 //BA.debugLineNum = 286;BA.debugLine="values(Col) = Value";
_values[_col] = _value;
 //BA.debugLineNum = 287;BA.debugLine="If visibleRows.ContainsKey(Row) Then";
if (_visiblerows.ContainsKey((Object)(_row))) { 
 //BA.debugLineNum = 288;BA.debugLine="Dim lbls() As Label";
_lbls = new anywheresoftware.b4a.objects.LabelWrapper[(int) (0)];
{
int d0 = _lbls.length;
for (int i0 = 0;i0 < d0;i0++) {
...
;
 //BA.debugLineNum = 289;BA.debugLine="lbls = visibleRows.Get(Row)";
_lbls = (anywheresoftware.b4a.objects.LabelWrapper[])(_visiblerows.Get((Object)(_row)));
 //BA.debugLineNum = 290;BA.debugLine="lbls(Col).Text = Value";
